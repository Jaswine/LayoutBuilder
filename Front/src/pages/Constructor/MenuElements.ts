        ...
        'elements': [
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;width: 100%; gap: 3%; margin-bottom: 10px; padding: 5%">
                <div style="display: flex; justify-content:center; align-items: center; flex-direction:column; width: 30%">
                    <img src="https://images.unsplash.com/photo-1682685796063-d2604827f7b3?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                    alt="" 
                ...
                <div style="display: flex; justify-content:center; align-items: center; flex-direction:column; width: 30%">
                    <img 
                        src="https://images.unsplash.com/photo-1682685796063-d2604827f7b3?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                        alt=""
                        style="width: 100%; border-radius: 6px" />
                    <h3>Card 2</h3>
                </div>
                <div style="display: flex; justify-content:center; align-items: center; flex-direction:column; width: 30%">
                    <img src="https://images.unsplash.com/photo-1682685796063-d2604827f7b3?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" 
                    style="width: 100%; border-radius: 6px" />
                    <h3>Card 3</h3>
                </div>
                <div style="display: flex; justify-content:center; align-items: center; flex-direction:column; width: 30%">
